...
export const Timeline = ({ children }: { children: React.ReactNode }) => {
  return (
    <AnimationContainer customClassName="w-full mb-16">
      <SectionHeader
        title="Experiencia"
        content="He tenido la oportunidad de adquirir experiencia valiosa como desarrollador trabajando en grandes empresas. A continuación se muestra un resumen de mi trabajo y las habilidades que he desarrollado en el camino."
      />
