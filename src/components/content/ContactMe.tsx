    ...
    if (siteConfig.contact.debug) {
      const fetchUserInfo = async () => {
        try {
          ...
          console.error('Error al obtener la user info:', error);
        }
      };
  ...
  return (
    <AnimationContainer customClassName="w-full">
      <SectionHeader
        id="contactme"
        title="Contáctame"
        content="Rellena el siguiente formulario para contactarme. Por favor, no hagas spam. Ya sea que tengas una pregunta sobre mi trabajo o colaboración en cualquier proyecto, no dudes en comunicarte."
      />
      ...
      <div className="w-full flex justify-between items-center flex-col mx-auto max-w-screen-xl">
        ...
        <div className="formulario-contacto w-full flex justify-center items-center flex-col">
          <form
          ...
          {isWaiting && (
            <div className="mt-4 text-red-500">
              <p>
                Necesitas esperar {waitTime} segundos{waitTime !== 1 && 's'} antes de
                enviar otro mensaje.
              </p>
            </div>
          )}
        ...
        <div className="fixed top-0 left-0 w-full h-full bg-black/60 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-neutral-800 rounded-xl p-6 shadow-lg text-center">
            ...
            <p className="text-base text-foreground dark:text-gray-400">
              Tu mensaje ha sido enviado correctamente a {siteConfig.social.email}{' '}
            </p>
            <Button
