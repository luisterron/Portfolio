  ...
  useEffect(() => {
    const fetchProjects = async () => {
      ...
      try {
        ...
        if (!response.ok) {
          throw new Error('Error obteniendo los proyectos');
        }
        ...
        setFetchError('Error obteniendo los proyectos'); // Set the error message
        ...
        <div className="w-full flex flex-col gap-6">
          ...
          <AnimationContainer customClassName="w-full flex flex-col gap-5 mb-8">
            <p className="w-full text-base text-black dark:text-white">
              Estos son la mayoría de los proyectos que he hecho desde que empecé a
              programar, algunos son proyectos personales, freelance, trabajo,
              práctica o por otras situaciones. Si quieres ver absolutamente
              todos mis proyectos, ve a mi{' '}
              <Link
          ...
          <SearchInput
            ...
            placeholder="Buscar proyectos (Lenguajes, frameworks, etc...)"
